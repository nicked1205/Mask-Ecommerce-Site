    ...
    >
      ...
      <div className="relative z-10 max-w-4xl mx-auto px-4 text-white">
        ...
        <div className="flex flex-col sm:flex-row gap-6 justify-center">
          <a
            href="#purchase"
            className="flex items-center justify-center w-60 h-14 bg-gradient-to-b from-gray-800 to-black rounded-full text-white font-semibold text-lg shadow hover:opacity-90 transition"
          >
            How to Purchase
          </a>
